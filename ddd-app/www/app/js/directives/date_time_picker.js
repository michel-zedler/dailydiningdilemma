(function () {
  ...
  ddd.directive('dateTimePicker', function ($ionicPopup) {
    return {
      restrict: 'E',
      ...
      controller: function ($scope, $filter, $ionicPopup) {
        ...
        $scope.popup = function () {
          $ionicPopup.show({
            template: '<div class="date-time-picker"><datetimepicker data-ng-model="tmp.newDate" data-on-time-set="onTimeSet"></datetimepicker></div>',
            title: $scope.title,
            scope: $scope,
            buttons: [
              {text: 'Cancel'},
